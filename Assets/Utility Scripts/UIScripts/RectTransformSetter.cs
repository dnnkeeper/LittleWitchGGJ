...
public class RectTransformSetter : MonoBehaviour
{
    ...
    public void CopyRectTransform(RectTransform rectTarget)
    {
        rt.anchorMin = rectTarget.anchorMin;
        rt.anchorMax = rectTarget.anchorMax;
        rt.anchoredPosition = rectTarget.anchoredPosition;
        rt.sizeDelta = rectTarget.sizeDelta;
    }
